    ...
    return(
        <div className="about">
            ...
            <div class="about_container">
				...
				Beside React i leart JavaScript(what is a must before learning React) and SCSS. I also finished a "2022 Complete Python Bootcamp From Zero to Hero in Python" course as a side learning. I was always interested learn this language as it has so much potentials.
